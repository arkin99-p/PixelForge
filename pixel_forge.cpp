...
bool PixelForge::init(const char* title, int width, int height) {
...
void PixelForge::rasterizeTriangle(const VertexOutput& v0, const VertexOutput& v1, const VertexOutput& v2) {
